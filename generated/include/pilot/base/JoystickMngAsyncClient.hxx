...
#ifndef INCLUDE_pilot_base_JoystickMng_ASYNC_CLIENT_HXX_
#define INCLUDE_pilot_base_JoystickMng_ASYNC_CLIENT_HXX_
...
class JoystickMngAsyncClient : public vnx::AsyncClient {
public:
	JoystickMngAsyncClient(const std::string& service_name);
	
	JoystickMngAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_pilot_base_JoystickMng_ASYNC_CLIENT_HXX_
