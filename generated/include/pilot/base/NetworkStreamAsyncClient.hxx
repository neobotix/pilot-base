...
#ifndef INCLUDE_pilot_base_NetworkStream_ASYNC_CLIENT_HXX_
#define INCLUDE_pilot_base_NetworkStream_ASYNC_CLIENT_HXX_
...
class NetworkStreamAsyncClient : public vnx::AsyncClient {
public:
	NetworkStreamAsyncClient(const std::string& service_name);
	
	NetworkStreamAsyncClient(vnx::Hash64 service_addr);
...
private:
	...
	std::unordered_map<uint64_t, std::pair<std::function<void()>, std::function<void(const vnx::exception&)>>> vnx_queue_connect;
	std::unordered_map<uint64_t, std::pair<std::function<void()>, std::function<void(const vnx::exception&)>>> vnx_queue_disconnect;
...
#endif // INCLUDE_pilot_base_NetworkStream_ASYNC_CLIENT_HXX_
