...
#ifndef INCLUDE_pilot_base_UDP_Sender_ASYNC_CLIENT_HXX_
#define INCLUDE_pilot_base_UDP_Sender_ASYNC_CLIENT_HXX_
...
class UDP_SenderAsyncClient : public vnx::AsyncClient {
public:
	UDP_SenderAsyncClient(const std::string& service_name);
	
	UDP_SenderAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_pilot_base_UDP_Sender_ASYNC_CLIENT_HXX_
