...
#ifndef INCLUDE_pilot_base_UDP_Sender_CLIENT_HXX_
#define INCLUDE_pilot_base_UDP_Sender_CLIENT_HXX_
...
class UDP_SenderClient : public vnx::Client {
public:
	UDP_SenderClient(const std::string& service_name);
	
	UDP_SenderClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_pilot_base_UDP_Sender_CLIENT_HXX_
