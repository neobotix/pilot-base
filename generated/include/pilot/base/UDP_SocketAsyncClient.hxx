...
#ifndef INCLUDE_pilot_base_UDP_Socket_ASYNC_CLIENT_HXX_
#define INCLUDE_pilot_base_UDP_Socket_ASYNC_CLIENT_HXX_
...
class UDP_SocketAsyncClient : public vnx::AsyncClient {
public:
	UDP_SocketAsyncClient(const std::string& service_name);
	
	UDP_SocketAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_pilot_base_UDP_Socket_ASYNC_CLIENT_HXX_
