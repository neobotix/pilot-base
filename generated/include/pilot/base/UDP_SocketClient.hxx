...
#ifndef INCLUDE_pilot_base_UDP_Socket_CLIENT_HXX_
#define INCLUDE_pilot_base_UDP_Socket_CLIENT_HXX_
...
class UDP_SocketClient : public vnx::Client {
public:
	UDP_SocketClient(const std::string& service_name);
	
	UDP_SocketClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_pilot_base_UDP_Socket_CLIENT_HXX_
