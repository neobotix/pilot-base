...
#ifndef INCLUDE_pilot_base_can_adapter_e_HXX_
#define INCLUDE_pilot_base_can_adapter_e_HXX_
...
struct can_adapter_e {
	...
	friend std::ostream& operator<<(std::ostream& _out, const can_adapter_e& _value);
	friend std::istream& operator>>(std::istream& _in, can_adapter_e& _value);
