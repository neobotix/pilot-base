...
void SerialPortBase::write(std::ostream& _out) const {
	_out << "{\"__type\": \"pilot.base.SerialPort\"";
...
std::shared_ptr<vnx::TypeCode> SerialPortBase::static_create_type_code() {
	...
	type_code->methods[0] = ::pilot::base::SerialPort_close_port::static_get_type_code();
	type_code->methods[1] = ::pilot::base::SerialPort_open_port::static_get_type_code();
...
void SerialPortBase::vnx_handle_switch(std::shared_ptr<const vnx::Sample> _sample) {
	...
	if(_type_hash == 0xcd0d2bd202ac0fb0ull) {
...
std::shared_ptr<vnx::Value> SerialPortBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
	...
	if(_type_hash == vnx::Hash64(0x325a9542af22132full)) {
