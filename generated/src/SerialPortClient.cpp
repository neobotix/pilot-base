...
::vnx::Object SerialPortClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("SerialPortClient: invalid return value");
	}
}
...
std::shared_ptr<const ::vnx::ModuleInfo> SerialPortClient::vnx_get_module_info() {
...
void SerialPortClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void SerialPortClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t SerialPortClient::vnx_self_test() {
