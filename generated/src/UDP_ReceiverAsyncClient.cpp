...
uint64_t UDP_ReceiverAsyncClient::close_port(const std::function<void()>& _callback) {
...
uint64_t UDP_ReceiverAsyncClient::open_port(const std::function<void()>& _callback) {
...
void UDP_ReceiverAsyncClient::vnx_purge_request(uint64_t _request_id) {
