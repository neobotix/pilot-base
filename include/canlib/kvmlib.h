...
typedef struct {
  ...
  uint32 flags;         ///< Message flags \ref canMSG_xxx or \ref LIN_xxx
...
#define kvmLOG_TYPE_MSG        2 ///< The type used in kvmLogMsgEx (CAN message)
...
#define kvmLOG_TYPE_LINMSG     5 ///< The type used in kvmLogMsgEx (LIN message)
/** @} */
...
typedef struct {
  ...
  union {
    kvmLogMsgEx        msg;     ///< A CAN/LIN message
